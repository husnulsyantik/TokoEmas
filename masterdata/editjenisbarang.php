                  ...
                  <div class="card">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                        ...
                        <input type="text" name="idjenis_barang" class="form-control" value="<?php echo $newID; ?>"disabled>

						<input type="text" class="form-control" name="idjenis_barang" value="<?php echo $_POST['idjenis_barang'];?>" disabled>
