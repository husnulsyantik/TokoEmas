            ...
            <div class="container-fluid">
              ...
              ?>
                          ...
                          <tr>
                             ...
                             <td><a class="btn btn-warning" data-toggle="modal" data-target="#myModal2" href="editpemesanan.php?update=<?php echo $data['id_pemesanan']; ?>"><i class="fa fa-pencil"></i></a>
                      ...
                      <div id="myModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                        <div role="document" class="modal-dialog modal-lg">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h4 id="exampleModalLabel" class="modal-title">Edit Pemesanan</h4>
                              <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
                            </div>
                            <div class="modal-body">
                               <form class="form-horizontal" action="input_pemesanan.php" method="post"> <!-- pembuatan form -->
                      ...
                      <label class="col-sm-3 form-control-label">ID Pemesanan</label>
                      <div class="col-sm-6">
                          <input type="text" name="id_pemesanan" class="form-control form-control-success"  value="<?php echo $array['id_pemesanan']; ?>" readonly> 
