            ...
            <div class="container-fluid">
              ...
              ?>
                          ...
                          <tr>
                             ...
                             <td>
                                 <a class="editadmin btn btn-warning" id='<?php echo $data['id_pemesanan'];?>' data-toggle="modal" data-target="#pemesanan">
                          <i class="fa fa-pencil"></i></a>
                                <a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ??'))
                          { location.href='transaksi/hapus_pemesanan.php?id=<?php echo $data['id_pemesanan'];?>' }" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                              </td>
                          </tr>
                          <?php } ?>
                        </tbody> 
                      ...
                      <div class="col-sm-6">
                        <input type="text" name="id_pemesanan" class="form-control form-control-success">
                      </div>
                    </div>
                                          <div class="form-group row">
