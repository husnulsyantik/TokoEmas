             ...
             <!-- Form Elements -->     
                  ...
                  <div class="card">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="form-group row">
                      <label class="col-sm-3 form-control-label">pinjam </label>
                      <div class="col-sm-6">
                        <input type="text" name="pinjam" class="form-control form-control-success">
                      </div>
                    </div>
                      <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                        <input type="text" name="ongkos" class="form-control form-control-warning">
                      </div>
                    </div>
