                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group row">
						  ...
						  <a href="penjualan1.php"><input type="button" value="<<&nbsp;Kembali&nbsp;" type="submit" class="btn btn-secondary"></a>&nbsp;&nbsp;
                          <a href="#"><input type="button" value="&nbsp;&nbsp;Lanjut&nbsp;>>&nbsp;&nbsp;" type="submit" class="btn btn-primary"></a>
                         </form>
                          </div>
                         </form>
						    </div>
