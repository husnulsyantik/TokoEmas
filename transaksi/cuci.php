...
<header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Cuci</h2>
            </div>
          </header>
            <!-- Forms Section-->
          <section class="forms"> 
             ...
             <!-- Form Elements -->     
                  ...
                  <div class="card">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                        <input type="date" name="tanggal" class="form-control form-control-success"> <!-- pembuatan inputan form -->
                      </div>
                    </div>
                      <div class="form-group row">
                      <label class="col-sm-3 form-control-label">Barang </label>
                      <div class="col-sm-6">
                        <input type="text" name="barang" class="form-control form-control-success">
                      </div>
                    </div>
                      <div class="form-group row">
                      <label class="col-sm-3 form-control-label">Berat </label>
                      <div class="col-sm-6">
                        <textarea type="text" name="berat" class="form-control form-control-success"></textarea>
                      </div>
                    </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                      <label class="col-sm-3 form-control-label">Tanggal Kembali </label>
                      <div class="col-sm-6">
                        <input type="date" name="tgl_kembali" class="form-control form-control-success">
                      </div>
                    </div>
                            ...
                            <div class="modal-footer">
                              <button type="button" data-dismiss="modal" class="btn btn-secondary">Tutup</button>
                                <a href="sales2.php"><button type="button" class="btn btn-primary">Simpan</button></a>
                            </div>
                          </div>
                        </div>
                      </div>
